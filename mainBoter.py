...
allMsg, afk, userColor, leftMsg, redBlack, nickRolled, gameHash = [], {}, {}, {}, [], {}, []
userHash, userTrip = {}, {}
...
OWNMENU = "\n".join([
    ...
    "|0addw 识别码|添加白名单用户（识别码）|0addw coBad2| ==addw==hitelist user|",
...
ENGMENU = "\n".join([
    ...
    "|~random| Get a random design. |~random|From [HERE](https://protobot.org/#zh) |",
